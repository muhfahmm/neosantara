              ...
              {isLoading ? (
                ...
                sortedRankings.map((row, index) => {
                  return (
                    ...
                    >
                      <td className={`px-4 py-2.5 font-black ${row.isPlayer ? "text-[#00FFAA]" : "text-[#E0E0E0]"}`}>
                        {index + 1}
                      </td>

                      <td className={`px-4 py-2.5 font-bold ${row.isPlayer ? "text-[#00FFAA]" : "text-[#E0E0E0]"}`}>
                        <div className="flex items-center gap-2.5">
                          ...
                          {row.isPlayer && (
                            <span className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400 border border-emerald-500/40 text-[9px] font-black uppercase tracking-wider ml-1">
                              <User className="w-2.5 h-2.5" /> Negara Anda
                            </span>
                          )}
                        </div>
                      </td>

                      <td className="px-4 py-2.5 text-center font-semibold text-[#6B8A8A]">
                        <div className="flex items-center justify-center gap-2">
                          <span>{row.system}</span>
                          <span className="px-2 py-0.5 rounded bg-[#0F2424] border border-[#00FFAA]/20 text-[10px] font-mono font-bold text-[#00FFAA]">
                            {row.spektrumVal}%
                          </span>
                        </div>
                      </td>
                      ...
                      <td className="px-4 py-2.5 text-right whitespace-nowrap">
                        <span
                          className={`inline-block px-3 py-1 rounded-full text-[10px] font-black uppercase border shadow-sm ${
