      ...
      {!isDetailOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center pt-[100px] sm:pt-[110px] lg:pt-[115px] pb-[16px] sm:pb-[20px] lg:pb-[20px] px-4 sm:px-8 bg-transparent pointer-events-none">
          <div className="bg-[#0F2424] border border-[#00FFAA]/30 rounded-2xl overflow-hidden w-full max-w-3xl lg:max-w-[920px] xl:max-w-[1020px] 2xl:max-w-5xl h-full max-h-[calc(100vh-125px)] sm:max-h-[calc(100vh-138px)] lg:max-h-[calc(100vh-145px)] flex flex-col relative font-sans pointer-events-auto">
            <div className="px-6 py-5 border-b border-[#00FFAA]/20 flex items-center justify-between bg-[#0A1A1A] relative z-10">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-[#00FFAA]/10 rounded-xl border border-[#00FFAA]/30">
                  <Handshake className="h-6 w-6 text-[#00FFAA]" />
                </div>
                <div>
                  <h2 className="text-lg font-bold text-[#00FFAA] tracking-tight uppercase">Mitra Dagang Global</h2>
                  <p className="text-[10px] text-[#6B8A8A] font-semibold">Jalin hubungan dagang dengan negara-negara di seluruh dunia</p>
                </div>
              </div>
