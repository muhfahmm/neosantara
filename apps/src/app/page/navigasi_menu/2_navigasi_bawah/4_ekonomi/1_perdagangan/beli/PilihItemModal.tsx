          ...
          {isGrouped ? (
            (data as CategoryGroup[]).map((group, groupIndex) => (
              <div key={groupIndex} className="mb-8 last:mb-0">
                <div className="col-span-full text-xs font-black text-[#00FFAA] uppercase tracking-wider mb-3 border-b border-[#00FFAA]/20 pb-2">
                  {group.category}
                </div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex flex-col gap-1">
                          ...
                          {item.disabled && (<span className="text-[10px] text-rose-400 font-bold uppercase">Tidak Tersedia</span>)}
                          {isSelected && (<span className="text-[10px] text-[#0A1A1A] font-extrabold uppercase">Terpilih</span>)}
                        </div>
                        {!item.disabled && (
