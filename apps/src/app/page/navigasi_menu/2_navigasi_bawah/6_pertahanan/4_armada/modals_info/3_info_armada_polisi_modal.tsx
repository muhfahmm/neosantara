...
interface InfoArmadaPolisiModalProps {
  isOpen: boolean;
  onClose: () => void;
  selectedItem: any;
...
export default function InfoArmadaPolisiModal({
  isOpen,
  onClose,
  selectedItem,
  formatNumber,
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-[#0F2424] relative z-10 space-y-4 text-xs font-semibold text-[#E0E0E0] custom-scrollbar">
          <div className="bg-[#0A1A1A] p-4 rounded-xl border border-[#00FFAA]/20">
            ...
            <p className="text-xl font-black text-white">
              {formatNumber(value)} {selectedItem?.satuan || "Unit"}
            </p>
          </div>
