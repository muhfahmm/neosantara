        ...
        <div className="px-4 sm:px-6 py-2.5 sm:py-3 border-b border-[#00FFAA]/20 flex items-center justify-between bg-[#0A1A1A] relative z-10 gap-2 shrink-0 rounded-t-2xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#6B8A8A] font-medium mt-1">Peran fasilitas kesehatan terhadap kematian di {countryName}</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-[#0A1A1A] border border-[#00FFAA]/20 p-6 rounded-2xl">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-black text-[#6B8A8A] uppercase tracking-wider">Ketersediaan RS & Klinik</p>
                  <p className="text-3xl font-black text-[#E0E0E0] mt-1">{result.jumlahRumahSakit} RS <span className="text-lg text-[#6B8A8A] font-bold">/ {formatNumber(populasi)} jiwa</span></p>
                </div>
              ...
              <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 gap-4">
                <div className="bg-[#0F2424] p-3 rounded-xl border border-emerald-500/30">
                  <p className="text-[10px] text-emerald-400 font-black uppercase">Bangunan Medis</p>
                  <p className="text-xl font-black text-emerald-400">{result.totalBangunanMedis} / {result.idealKesehatan}</p>
                </div>
                <div className="bg-[#0F2424] p-3 rounded-xl border border-[#00FFAA]/20">
                  <p className="text-[10px] text-[#6B8A8A] font-black uppercase">Rasio Fasilitas</p>
                  <p className="text-xl font-black text-[#E0E0E0]">{result.kesehatanRatio.toFixed(2)}</p>
                </div>
                <div className="bg-[#0F2424] p-3 rounded-xl border border-rose-500/30">
                  ...
                  <p className="text-xl font-black text-rose-400">× {result.healthFactor.toFixed(3)}</p>
                </div>
              </div>
